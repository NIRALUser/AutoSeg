/*=========================================================================
  ...
  Program:   CortThick
  Module:    $RCSfile: CortThick_gui.cxx,v $
  Language:  C++
...
int main(int argc, char *argv[])
{
  if(argc == 1)
  {
    ImageVGUIControls MainWindow;
    MainWindow.g_MainWindow->show();
    Fl::run();
    return 1;
  }
  ...
  {     
    ...
    if(SepImage)
       ImageVGUIControls MainWindow(White,grey,output,WhiteComponent,GreyComponent,VtkFile, ParFileName, ParFile, WriteWhiteDistance,WriteGreyDistance,WriteBoundThickAndNonBoundThick,WriteDistanceMapWhiteImage,WriteDistBoundMapGreyMat,Interp, Threshold);
    else if(SegImage)
      ImageVGUIControls MainWindow( atoi(levelWhite), atoi(levelGrey), Segfile,output, WhiteComponent, GreyComponent, VtkFile, ParFileName, ParFile,WriteWhiteDistance, WriteGreyDistance, WriteBoundThickAndNonBoundThick, WriteDistanceMapWhiteImage, WriteDistBoundMapGreyMat,Interp, Threshold);
